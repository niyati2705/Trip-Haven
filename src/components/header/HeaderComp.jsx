...
const Header = ({type}) => {
  ...
  return (
   ...
   { type!=="list" && // true for homepage, not otherwise
    <>
    <h1 className="headerTitle">LifeTime of Discounts? It's a genius</h1>
     <p className="headerDesc">
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam hic sequi necessitatibus laboriosam quas in officiis, placeat velit. Illum, iusto!
    </p>
    ...
    <div className="headerSearch">
      ...
      <div className="headerSearchItem">
      <FontAwesomeIcon icon={faCalendarDays} classNmae="headerIcon" />
